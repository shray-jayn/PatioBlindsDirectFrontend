...
const Footer = ({ onEstimateClick }: FooterProps) => {
  return (
    <footer className="bg-[#1A2332] text-[#C4C4C4] border-t border-[#2D3E50]">
      <div className="container mx-auto px-4 lg:px-8 py-12 lg:py-16">
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 mb-8">
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              <Button
                size="lg"
                asChild
                className="btn-gold hover:shadow-lg hover:scale-105 transition-all"
              >
          ...
          <div className="bg-[#2D3E50] rounded-2xl p-6 lg:p-8 border border-[#D4AF78]/20">
        ...
        <div className="border-t border-[#2D3E50] pt-8">
