...
const Guarantee = ({ onEstimateClick }: GuaranteeProps) => {
  return (
    <section className="py-12 lg:py-20 px-4 bg-gradient-to-br from-blue-600 to-blue-700 text-white">
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="text-center">
          <Button
            ...
            className="bg-white text-blue-600 hover:bg-blue-50 hover:scale-105 transition-all shadow-xl"
          >
